<footer class="bg-gray-900 text-gray-100 pb-20 lg:pb-0">
  <div class="container mx-auto px-4 py-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <p class="text-gray-400 text-sm leading-relaxed">
          ...
          We help you find your perfect property or vehicle.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><span class="text-sm text-gray-400">Residential</span></li>
          <li><span class="text-sm text-gray-400">Commercial</span></li>
          <li><span class="text-sm text-gray-400">Industrial</span></li>
          <li><span class="text-sm text-gray-400">Agricultural</span></li>
          <li><span class="text-sm text-gray-400">Mixed Use</span></li>
        </ul>
      </div>
    ...
    <div class="mt-12 pt-8 border-t border-gray-700 text-center">
      <p class="text-sm text-gray-500">
        &copy; 2025 Properties Investment. All rights reserved.
      </p>
    </div>
  </div>
</footer>