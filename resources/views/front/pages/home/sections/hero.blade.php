            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-4 md:p-6 max-w-4xl mx-auto">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <select class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 bg-white focus:outline-none cursor-pointer"
                                style="--tw-ring-color:#e75740;"
                                onfocus="this.style.outline='none'; this.style.boxShadow='0 0 0 2px rgba(231,87,64,0.3)';"
                    ...
                    <div class="flex flex-col justify-end">
                        <button class="w-full active:scale-95 text-white font-medium text-sm px-4 py-2.5 rounded-lg transition-all flex items-center justify-center gap-2"
